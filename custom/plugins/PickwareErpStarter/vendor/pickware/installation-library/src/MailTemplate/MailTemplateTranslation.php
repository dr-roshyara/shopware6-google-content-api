...
{
    /**
     * Type is nullable for backwards-compatibility reasons
     * @deprecated tag:next-major Nullability of this property will be removed
     */
    ...
    public static function fromArray(array $array): self
    {
        ...
        /**
         * @deprecated tag:next-major Nullability of this entry will be removed
         */
        $self->typeName = $array['typeName'] ?? null;
