...
class MailTemplate
{
     ...
     * https://github.com/shopware/platform/blob/eb7b60826e9b69ed1e20e1cdaed6f28c2da90957/src/Administration/Resources/app/administration/src/module/sw-mail-template/page/sw-mail-template-detail/index.js#L90-L107)
     *
     * @var string[]
     */
    ...
    /**
     * @deprecated Parameter $actions will be removed with next major release
    ...
    public function __construct(
        ...
        array $actions,
        array $translations,
        ?array $availableTemplateVariables = null
    ) {
        if ($availableTemplateVariables !== null) {
            ...
            $this->availableTemplateVariables = $translations;
        }
    }
