...
abstract class AbstractEntityInsertRestrictor implements EventSubscriberInterface
{
    ...
    public function preValidate(PreWriteValidationEvent $event): void
    {
        ...
        foreach ($commands as $command) {
            ...
            if (!($command instanceof InsertCommand) || !in_array($className, $this->classNames, true)) {
                continue;
            }
