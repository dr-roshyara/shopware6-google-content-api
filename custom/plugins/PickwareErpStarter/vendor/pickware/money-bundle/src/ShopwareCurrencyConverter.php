...
class ShopwareCurrencyConverter implements CurrencyConverter
{
    ...
    public function convertMoneyValueToCurrency(MoneyValue $moneyValue, Currency $currency): MoneyValue
    {
        $factor = null;
        if ($moneyValue->getValue() === 0.0 || $moneyValue->getCurrency()->equals($currency)) {
            ...
            $sourceCurrency = $this->entityManager->findOneBy(CurrencyDefinition::class, [
            ...
            $targetCurrency = $this->entityManager->findOneBy(CurrencyDefinition::class, [
