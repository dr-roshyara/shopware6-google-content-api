...
class SystemConfigServiceDecorator extends SystemConfigService
{
    ...
    private SystemConfigService $decoratedSystemConfigService;
    private bool $disableMailDelivery = false;

    public function __construct(SystemConfigService $decoratedSystemConfigService)
    {
        $this->decoratedSystemConfigService = $decoratedSystemConfigService;
    }
