...
class AnalyticsController
{
     ...
     * @Route(
     *     "/api/_action/pickware-erp/analytics/ensure-aggregation-session-exists",
     *     methods={"POST"}
     * )
     */
     ...
     * @RouteScope(scopes={"api"})
     * @Route(
     *     "/api/_action/pickware-erp/analytics/ensure-report-config-exists",
     *     methods={"POST"}
     * )
     */
     ...
     * @RouteScope(scopes={"api"})
     * @Route(
     *     "/api/_action/pickware-erp/analytics/aggregate",
     *     methods={"POST"}
     * )
     */
     ...
     * @RouteScope(scopes={"api"})
     * @Route(
     *     "/api/_action/pickware-erp/analytics/calculate-report-list-items",
     *     methods={"POST"}
     * )
     */
