...
class SupplierExporter implements Exporter
{
    ...
    public function getCsvFileName(string $importExportId, string $locale, Context $context): string
    {
        ...
        return sprintf(
            $this->translator->translate('pickware-erp-starter.supplier-export.file-name') . '.csv',
    ...
    private function getSupplierExportRows(Criteria $criteria, string $locale, array $columns, Context $context): array
    {
        ...
        $suppliers = $context->enableInheritance(function (Context $inheritanceContext) use ($criteria) {
