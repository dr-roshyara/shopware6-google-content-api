...
class StockMovementDefinition extends EntityDefinition
{
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            new FkField('source_supplier_order_id', 'sourceSupplierOrderId', SupplierOrderDefinition::class, 'id'),
            new ManyToOneAssociationField('sourceSupplierOrder', 'source_supplier_order_id', SupplierOrderDefinition::class, 'id'),
            ...
            new FkField('destination_supplier_order_id', 'destinationSupplierOrderId', SupplierOrderDefinition::class, 'id'),
            new ManyToOneAssociationField('destinationSupplierOrder', 'destination_supplier_order_id', SupplierOrderDefinition::class, 'id'),
