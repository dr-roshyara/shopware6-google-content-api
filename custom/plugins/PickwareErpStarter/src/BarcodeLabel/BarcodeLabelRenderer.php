...
class BarcodeLabelRenderer
{
    ...
    public function render(BarcodeLabelConfiguration $labelConfiguration, array $data): GeneratedDocument
    {
        ...
        $generatedDocument->setHtml($renderedHtml);
        $generatedDocument->setFileBlob($dompdf->output());
        $generatedDocument->setContentType('application/pdf');
        $generatedDocument->setFilename(sprintf(
