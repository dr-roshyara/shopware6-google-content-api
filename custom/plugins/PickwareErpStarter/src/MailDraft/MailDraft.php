...
class MailDraft implements JsonSerializable
{
    ...
    public function jsonSerialize(): array
    {
         return [
             ...
             'contentPlain' => $this->getContentPlain(),
    ...
    public static function fromArray(array $array): self
    {
        ...
        $self->setContentPlain($array['contentPlain']);
    ...
    /**
     * Returns the content (plain and HTML) of the mail. Note that we only support sending plain text mails for now.
     */
    public function getContents(): array
    {
        return [
            'text/plain' => $this->contentPlain,
        ];
    }
    ...
    public function getAdditionalData(): array
    {
        ...
        // to send BCC e-mails to multiple recipients (see also https://github.com/shopware/platform/issues/2862).
